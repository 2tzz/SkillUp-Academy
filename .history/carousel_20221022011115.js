...
class Carousel {
  constructor(el) {
    ...
    this.carouselData = [
      {
        'id': '1',
        'src': '\Img\CarousalImages\Caro1.jpg',
      },
      {
        'id': '2',
        'src': '\Img\CarousalImages\Caro2.jpg',
      },
      {
        'id': '3',
        'src': 'https://drive.google.com/file/d/10_JPhC8EE2S1u26ZiQ_rdIDGWWVt8CkT/view?usp=sharing',
      },
      {
        'id': '4',
        'src': 'https://drive.google.com/file/d/1ZRD2dHtB5hvE6SqCuSMKQekwpIl-w7f9/view?usp=sharing',
      },
      {
        'id': '5',
        'src': 'https://drive.google.com/file/d/19kZ6Mv9ftfrAt_9NoMoJYMc-sKpb47vK/view?usp=sharing,
      }
    ];
