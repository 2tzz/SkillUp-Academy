...
<!-- Form starts here -->
  <section>
    <div class="form-container">
      ...
      <form action="#">
        <div class="control">
          <label for="userName">New username</label><input type="text" name="userName" id="userName"><label for="cfuserName">New username</label><input type="text" name="cfuserName" id="cfuserName">
        </div>
        <div class="control">
